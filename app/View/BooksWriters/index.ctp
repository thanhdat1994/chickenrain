<div class="booksWriters index">
	...
	<tr>
		...
		<td class="actions">
			...
			<?php echo $this->Form->postLink(__('Delete'), array('action' => 'delete', $booksWriter['BooksWriter']['id']), array('confirm' => __('Are you sure you want to delete # %s?', $booksWriter['BooksWriter']['id']))); ?>
		</td>
	</tr>
<?php endforeach; ?>
	</tbody>
